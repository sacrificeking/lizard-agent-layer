...
4. Load the one best matching skill from `.agents/skills/*/SKILL.md` (and `.agent/skills-local/*/SKILL.md` if present, usually `implementation`); add at most one specialist if needed. Explicitly named skills take precedence.
