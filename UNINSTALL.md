...
> - **1-Liner:** `pwsh -File "$HOME/.lizard-agent-layer/scripts/uninstall.ps1" -TargetPath "." -Scope managed-only -CanonicalPlanPath "$HOME/.lizard-agent-layer/.tmp/uninstall-plan.json"`
